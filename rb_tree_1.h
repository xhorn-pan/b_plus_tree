...
public:
  ...
  virtual ~rb_tree() { if(root) destory_(root); };
...
template <class data_type, template <class> class node_type>
inline void rb_tree<data_type, node_type>::fix_delete_(node_type<data_type> *dnode,
    node_type<data_type> *pod, node_type<data_type> *cod) {
  if(root == cod) {
